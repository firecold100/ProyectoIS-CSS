            ...
            <div class="row main">
                <div class="main-login main-center">
                    ...
                    <form action="/ProyectoIS-CSS/registrar" method="GET">
                           ...
                           <label for="correo" class="cols-sm-2 control-label" >Email</label>
                            <div class="cols-sm-10">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control"  name="correo" id="correo"  placeholder="Enter your Email" required/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="confirm" class="cols-sm-2 control-label">Gustos Culposos</label>
